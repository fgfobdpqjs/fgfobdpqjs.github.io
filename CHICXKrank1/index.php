...
<head>
    ...
    <link href="https://chicxk.pages.dev/static/index.css" rel="stylesheet" type="text/css">
    <script src="https://chicxk.pages.dev/files/js/createjs.min.js"></script>
    <script src="https://chicxk.pages.dev/files/js/jsencrypt.min.js"></script>
    <link href="https://chicxk.pages.dev/files/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://chicxk.pages.dev/files/js/bootstrap.bundle.min.js"></script>
    <script src="https://chicxk.pages.dev/files/js/jquery.min.js"></script>
    <script src="https://chicxk.pages.dev/files/json/city.json"></script>
	<?php
    session_start();
