...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://b23.tv/2ppz1O4'" data-i18n="yee">YEE-I18N</button>
            </div>
    </div>
    </div>
            ...
            <div class="container">
                ...
                <div id="setting" class="container" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input data-placeholder-i18n="eat-wangye" type="text" id="title" class="form-control" placeholder="EAT-WANGYE-I18N">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend col-2">
